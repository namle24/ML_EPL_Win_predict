...
print(f" The percentage of the champions have had the single top goalscorer:{percentage_formatted}")
...
actual_predicted_rf = pd.DataFrame({'Actual wins': y_test.squeeze(), 'Predicted wins': y_pred_rf.squeeze()}).reset_index(drop=True)

# Create a line plot for actual wins
plt.plot(actual_predicted_rf.index, actual_predicted_rf['Actual wins'], label='Actual Wins')

# Create a line plot for predicted wins using Random Forest
plt.plot(actual_predicted_rf.index, actual_predicted_rf['Predicted wins'], label='Predicted Wins (Random Forest)')
...
sns.scatterplot(x='Predicted wins', y='Actual wins', data=actual_predicted_rf)

# Add the regression line for Random Forest
sns.regplot(x='Predicted wins', y='Actual wins', data=actual_predicted_rf, scatter=False, color='red')
